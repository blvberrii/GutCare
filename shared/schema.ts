...
export const scans = pgTable("scans", {
  ...
  productDetails: jsonb("product_details"), // { specifications, suitability, directionsForUse, safetyInfo, storageInfo, contraindications, sideEffects, deficiencyEffects }
