...
export default function AuthPage({ initialTab = "register" }: { initialTab?: "login" | "register" }) {
  ...
  return (
    <div className="relative isolate min-h-[100dvh] sm:min-h-screen bg-[#FFFDF9] flex flex-col overflow-x-clip">
      ...
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[8%] left-[35%] w-[22rem] h-[22rem] bg-coral-200/70 rounded-full blur-2xl transform-gpu" />
      ...
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[34%] left-[42%] w-[26rem] h-[26rem] bg-teal-300/45 rounded-full blur-2xl transform-gpu" />
      ...
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[56%] left-[30%] w-[24rem] h-[24rem] bg-coral-300/70 rounded-full blur-2xl transform-gpu" />
