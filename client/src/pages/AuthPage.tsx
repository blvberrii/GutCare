...
export default function AuthPage({ initialTab = "register" }: { initialTab?: "login" | "register" }) {
  ...
  return (
    <div className="relative isolate min-h-[100dvh] sm:min-h-screen bg-[#FFFDF9] flex flex-col overflow-x-clip overflow-y-clip">
      ...
      <div aria-hidden className="pointer-events-none absolute -z-10 -top-[20%] -left-[15%] w-[70rem] h-[70rem] bg-teal-300/75 rounded-full blur-[160px] transform-gpu" />
      <div aria-hidden className="pointer-events-none absolute -z-10 -top-[25%] -right-[15%] w-[70rem] h-[70rem] bg-coral-300/55 rounded-full blur-[160px] transform-gpu" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[20%] left-[40%] -translate-x-1/2 w-[60rem] h-[60rem] bg-teal-300/65 rounded-full blur-[180px] transform-gpu" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[55%] -left-[10%] w-[55rem] h-[55rem] bg-teal-300/70 rounded-full blur-[160px] transform-gpu" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[60%] -right-[10%] w-[55rem] h-[55rem] bg-coral-200/50 rounded-full blur-[160px] transform-gpu" />
