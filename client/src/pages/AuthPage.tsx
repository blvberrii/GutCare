...
export default function AuthPage({ initialTab = "register" }: { initialTab?: "login" | "register" }) {
  ...
  return (
    <div className="relative isolate min-h-[100dvh] sm:min-h-screen bg-[#FFFDF9] flex flex-col overflow-x-clip">
      ...
      <div aria-hidden className="pointer-events-none absolute -z-10 -top-32 -left-24 w-[28rem] h-[28rem] bg-teal-300/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="pointer-events-none absolute -z-10 -top-20 -right-32 w-[26rem] h-[26rem] bg-coral-300/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[30%] -left-32 w-[24rem] h-[24rem] bg-coral-200/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[35%] -right-24 w-[26rem] h-[26rem] bg-teal-200/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[60%] -left-24 w-[26rem] h-[26rem] bg-teal-300/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[65%] -right-32 w-[28rem] h-[28rem] bg-coral-300/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="pointer-events-none absolute -z-10 -bottom-24 left-1/4 w-[28rem] h-[28rem] bg-coral-200/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="pointer-events-none absolute -z-10 -bottom-32 right-1/4 w-[26rem] h-[26rem] bg-teal-200/55 rounded-full blur-[110px] md:blur-[200px] md:scale-[1.6]" />
      {/* Back to home */}
