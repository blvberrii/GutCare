...
export default function SearchPage() {
  ...
  return (
    <div className="relative isolate min-h-screen flex flex-col overflow-x-clip bg-[#FFFDF9]">
...
function ProductRow({
  ...
  return (
    ...
    >
      ...
      >
        <div className={`relative w-10 h-10 rounded-xl overflow-hidden flex-shrink-0 ${imgUrl ? "bg-white p-1" : "bg-gray-100"}`}>
          {imgLoading ? (
