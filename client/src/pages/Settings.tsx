...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen pb-24 font-sans" style={{background:"radial-gradient(ellipse 60% 50% at 0% 0%, rgba(94,193,201,0.45), transparent 60%), radial-gradient(ellipse 70% 50% at 100% 35%, rgba(255,158,128,0.40), transparent 60%), radial-gradient(ellipse 80% 50% at 30% 100%, rgba(255,180,150,0.45), transparent 60%), #FFFDF9"}}>
