...
export default function Home() {
  ...
  return (
    <div className="relative isolate min-h-screen pb-32 overflow-x-clip bg-[#FFFDF9]">
      ...
      <div aria-hidden className="pointer-events-none absolute -z-10 -top-32 -left-24 w-[26rem] h-[26rem] bg-teal-300/45 rounded-full blur-2xl transform-gpu" />
      <div aria-hidden className="pointer-events-none absolute -z-10 -top-20 -right-24 w-[24rem] h-[24rem] bg-coral-300/70 rounded-full blur-2xl transform-gpu" />
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[28%] -right-32 w-[22rem] h-[22rem] bg-teal-200/45 rounded-full blur-2xl transform-gpu" />
      ...
      <div aria-hidden className="pointer-events-none absolute -z-10 top-[78%] -left-20 w-[22rem] h-[22rem] bg-coral-300/70 rounded-full blur-2xl transform-gpu" />
      <div aria-hidden className="pointer-events-none absolute -z-10 -bottom-24 right-[20%] w-[24rem] h-[24rem] bg-coral-200/70 rounded-full blur-2xl transform-gpu" />
        ...
        {!isSearching && (
          <>
            ...
            >
              ...
              <div className="absolute top-[-20px] right-[-20px] w-48 h-48 bg-white/10 rounded-full blur-2xl transform-gpu" />
            </motion.div>
