...
export default function Onboarding() {
  ...
  return (
    <div className="relative isolate min-h-screen bg-[#FFFDF9] flex flex-col p-6 overflow-clip">
      ...
      {/* Mobile center blobs */}
      <div aria-hidden className="md:hidden pointer-events-none absolute -z-10 top-[35%] left-1/2 -translate-x-1/2 w-[20rem] h-[20rem] bg-teal-300/45 rounded-full blur-[110px]" />
      <div aria-hidden className="md:hidden pointer-events-none absolute -z-10 top-[70%] left-1/2 -translate-x-1/2 w-[20rem] h-[20rem] bg-coral-300/70 rounded-full blur-[110px]" />

      {/* Desktop center blobs */}
      <div aria-hidden className="hidden md:block pointer-events-none absolute -z-10 top-[28%] left-1/2 -translate-x-1/2 w-[32rem] h-[32rem] bg-coral-200/70 rounded-full blur-[200px] md:scale-[1.6]" />
      <div aria-hidden className="hidden md:block pointer-events-none absolute -z-10 top-[58%] left-1/2 -translate-x-1/2 w-[34rem] h-[34rem] bg-teal-300/45 rounded-full blur-[200px] md:scale-[1.6]" />
