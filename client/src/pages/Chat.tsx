...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col" style={{ height: "calc(100dvh - 76px)", background: "radial-gradient(ellipse 70% 45% at 0% 0%, rgba(94,193,201,0.55), transparent 75%), radial-gradient(ellipse 70% 45% at 100% 0%, rgba(255,158,128,0.50), transparent 75%), radial-gradient(ellipse 90% 50% at 50% 100%, rgba(255,180,150,0.60), transparent 75%), #FFFDF9" }}>
